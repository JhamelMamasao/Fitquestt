         ...
         <View style={styles.ModalBoxs}>
             <View style={styles.Modals2}>
               <Text style={styles.ModalText2}>Challenge Has Been Set!</Text>
                 ...
                 <Text style={styles.ModalText1}>Your challenge has been successfully dispatched to the designated recipient. Stay tuned for their response and keep your competitive spirit high!</Text>
                 <Pressable onPress={() => setModalVisible2(!modalVisible2)} style={styles.Buttons3}>
