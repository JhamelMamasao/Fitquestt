        ...
        <SafeAreaView style={styles.container}>
            ...
            {players.length > 1 && (
                <View style={[styles.box, styles.leftTopPlayer]} key={"top2"}>
                    ...
                    <Image style={styles.profile} source={players[1]?.profile ? {uri: players[1]?.profile} : require('../assets/images/placeholder.jpg')} />
            ...
            {players.length > 0 && (
                <View style={[styles.boxs, styles.topPlayer]} key={"top1"}>
                    ...
                    <Image style={styles.profiles} source={players[0]?.profile ? {uri: players[0]?.profile} : require('../assets/images/placeholder.jpg')} />
            ...
            {players.length > 2 && (
                <View style={[styles.box, styles.rightTopPlayer]} key={"top3"}>
                    ...
                    <Image style={styles.profile} source={players[2]?.profile ? {uri: players[2]?.profile} : require('../assets/images/placeholder.jpg')} />
...
<Image source={require('../assets/images/top3.png')} style={styles.top1} />
                ...
                {players.slice(3).map((player, index) => (
                    <View style={styles.otherboxes} key={index}>
                        <View style={styles.otherContainer}>
                            ...
                            <Image style={styles.ProfileOther} source={player.profile ? {uri: player.profile} : require('../assets/images/placeholder.jpg')} />
    ...
    <Text style={styles.numberss}>
        {players.findIndex(p => p.first_name === name && p.last_name === names) === -1 ? "N/A" : (players.findIndex(p => p.first_name === name && p.last_name === names) + 1 <= 10 ? players.findIndex(p => p.first_name === name && p.last_name === names) + 1 : "N/A")}
    </Text>
    {profile ? (
        <Image style={styles.profilesss} source={{ uri: profile }} />
    ) : (
        <Image style={styles.profile} source={{ uri: './assets/images/placeholder.jpg' }} />
    )}
    ...
    <Text style={styles.footerTexts}>{parseFloat(exp).toFixed(1).replace(/\.0$/, '').slice(0, 6)}</Text>
        ...
        <View style={styles.navbar}>
          <View style={styles.IconContainer}>
            ...
            <View style={styles.iconTextWrapper}>
              <Image source={require('../assets/images/chaorange.png')} style={styles.logos} />
