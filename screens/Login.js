   ...
   <SafeAreaView style={styles.container}>
     ...
     <Pressable onPress={() => navigation.goBack()} style={styles.backButton}>
      <Image source={require('../assets/images/backwhite.png')} style={styles.back} />
          ...
          <Text style={styles.Description}>Continue your Adventure.</Text>
     </View>
     ...
     <Text style={styles.inputText}>Username</Text>
      ...
      <Pressable onPress={handleForgotPassword} ><Text style={styles.forgot}>Forgot Password?</Text></Pressable>
