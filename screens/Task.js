...
const TaskWalkingScreen = () => {
    ...
    const [taskCompleted, setTaskCompleted] = useState(false); // Track task completion
    ...
    const navigateToTracking = () => {
        navigation.navigate('Tracking', { taskSlug: slug, targetDistance: Km, onComplete: handleTaskCompletion });
    };

    const handleTaskCompletion = () => {
        setTaskCompleted(true); // Set task as completed
