    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.separator} />
                ...
                <Image source={require('../assets/images/bg4.png')} style={styles.coverImage} />
                ...
                <Image source={require('../assets/images/bg2.png')} style={styles.coverImage} />
                <View style={styles.inner}>
                    <BlurView intensity={10} tint='light' style={styles.textContainer}>
                ...
                <Image source={require('../assets/images/bg5.png')}style={styles.coverImage}/>
                <View style={styles.inner}>
                    <BlurView intensity={10} tint='light' style={styles.textContainer}>
                ...
                <Image source={require('../assets/images/bg3.png')} style={styles.coverImage}/>
                <View style={styles.inner}>
                <BlurView intensity={10} tint='light' style={styles.textContainer}>
