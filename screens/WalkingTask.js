    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.separator} />
                ...
                <ImageBackground source={require('../assets/images/bg6.png')} style={styles.box}>
                ...
                <ImageBackground source={require('../assets/images/bg7.png')} style={styles.box}>
                ...
                <ImageBackground source={require('../assets/images/bg9.png')} style={styles.box}>
                <View style={styles.inner}>
                    <BlurView intensity={90} tint='dark' style={styles.textContainer}>
                ...
                <ImageBackground source={require('../assets/images/bg10.png')} style={styles.box}>
                <View style={styles.inner}>
                <BlurView intensity={90} tint='dark' style={styles.textContainer}>
